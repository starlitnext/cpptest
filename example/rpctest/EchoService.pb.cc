...
static ::_pb::Metadata file_level_metadata_EchoService_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_EchoService_2eproto = nullptr;
static const ::_pb::ServiceDescriptor* file_level_service_descriptors_EchoService_2eproto[1];

const uint32_t TableStruct_EchoService_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_EchoService_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021EchoService.proto\022\004echo\"\032\n\013EchoRequest"
  "\022\013\n\003msg\030\001 \002(\t\"\033\n\014EchoResponse\022\013\n\003msg\030\002 \002"
  "(\t2;\n\nEchoServer\022-\n\004Echo\022\021.echo.EchoRequ"
  "est\032\022.echo.EchoResponseB\003\200\001\001"
  ;
static ::_pbi::once_flag descriptor_table_EchoService_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_EchoService_2eproto = {
    false, false, 148, descriptor_table_protodef_EchoService_2eproto,
    "EchoService.proto",
    &descriptor_table_EchoService_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_EchoService_2eproto::offsets,
    file_level_metadata_EchoService_2eproto, file_level_enum_descriptors_EchoService_2eproto,
    file_level_service_descriptors_EchoService_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_EchoService_2eproto_getter() {
  return &descriptor_table_EchoService_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_EchoService_2eproto(&descriptor_table_EchoService_2eproto);
namespace echo {
...
::PROTOBUF_NAMESPACE_ID::Metadata EchoRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_EchoService_2eproto_getter, &descriptor_table_EchoService_2eproto_once,
      file_level_metadata_EchoService_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata EchoResponse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_EchoService_2eproto_getter, &descriptor_table_EchoService_2eproto_once,
      file_level_metadata_EchoService_2eproto[1]);
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* EchoServer::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_EchoService_2eproto);
  return file_level_service_descriptors_EchoService_2eproto[0];
}
...
void EchoServer::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_EchoService_2eproto[0]);
  switch(method->index()) {
    case 0:
      Echo(controller,
